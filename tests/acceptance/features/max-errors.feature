 ...
 Feature: Invalid Tag
     ...
     When Gherklin is ran with the following configuration
      | rules                                                                                     | maxErrors |
      | {"allowed-tags": ["error", ["@development"]], "indentation": ["error", { "feature": 1 }]} | 0         |
     ...
     And the errors are
      ...
      | {"line": 2, "column": 3} | error    | indentation  | Invalid indentation for feature. Got 2, wanted 1                               |
