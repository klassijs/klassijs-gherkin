...
describe('Config', () => {
    ...
    describe('validate', () => {
        ...
        it('throws if theres no featureDirectory and featureFile', () => {
            expect(() => new Config({})).to.throw(Error, 'Please specify either a featureDirectory or featureFile configuration option, or set GHERKLIN_FEATURE_DIR or GHERKLIN_FEATURE_FILES environment variable.');
        });
