...
var NoFullStop = /** @class */ (function () {
    function NoFullStop(rawSchema) {
        this.name = 'no-full-stop';
        this.acceptedSchema = schemas_js_1.switchOrSeveritySchema;
        this.schema = new schema_js_1.default(rawSchema);
    }
    NoFullStop.prototype.run = function (document) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                document.lines.forEach(function (line, index) {
                    var trimmed = line.text.trimEnd();
                    if (trimmed[trimmed.length - 1] === '.') {
                        document.addError(_this, "Line ends with a full stop.", {
                            line: index + 1,
    ...
    NoFullStop.prototype.fix = function (document) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
