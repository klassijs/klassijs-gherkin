...
var NoEmptyFile = /** @class */ (function () {
    function NoEmptyFile(rawSchema) {
        this.name = 'no-empty-file';
        this.acceptedSchema = schemas_js_1.switchOrSeveritySchema;
        this.schema = new schema_js_1.default(rawSchema);
    }
    NoEmptyFile.prototype.run = function (document) {
