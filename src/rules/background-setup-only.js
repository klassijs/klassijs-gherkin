...
var BackgroundSetupOnly = /** @class */ (function () {
    function BackgroundSetupOnly(rawSchema) {
        this.name = 'background-setup-only';
        this.acceptedSchema = schemas_js_1.switchOrSeveritySchema;
        this.schema = new schema_js_1.default(rawSchema);
    }
    BackgroundSetupOnly.prototype.run = function (document) {
    ...
    return BackgroundSetupOnly;
}());
exports.default = BackgroundSetupOnly;
